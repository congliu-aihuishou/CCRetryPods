#
#  Be sure to run `pod spec lint CCRetryPods.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "CCRetryPods"
  s.version      = "0.0.1"
  s.summary      = "A Test Demo named CCRetryPods."
  ...
  s.homepage     = "https://github.com/congliu-aihuishou/CCRetryPods"
  ...
  s.author             = { "cong.liu" => "cong.liu@aihuishou.com" }
  # Or just: s.author    = "cong.liu"
  # s.authors            = { "cong.liu" => "cong.liu@aihuishou.com" }
  # s.social_media_url   = "http://twitter.com/cong.liu"
  ...
  s.source       = { :git => "https://github.com/congliu-aihuishou/CCRetryPods.git", :tag => "#{s.version}" }
